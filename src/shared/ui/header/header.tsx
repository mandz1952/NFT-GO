        ...
        <div className={'mb-3'}>
            <div className="flex items-center justify-between px-4 py-4 gap-1">
                ...
                <div className="flex items-center gap-2">
                    <div
                        className="bg-[#231c46] border-2 border-[#533189] rounded-lg px-2 py-1 flex items-center gap-2">
                        <Image src={'/tonCoin.svg'} alt={"ton Coin"} width={18} height={18}/>
                        <span className="text-white text-lg font-semibold">0.00</span>
                        <Button className="bg-[#21ee43] hover:bg-[#21ee43]/90 text-black w-5 h-5 p-0 mr-2">
                            <Plus className="w-4 h-4"/>
                        </Button>
                    </div>

                </div>
                <div className="bg-[#231c46] border-2 border-[#533189] rounded-lg px-1 py-0 flex items-center">
                    <Button
